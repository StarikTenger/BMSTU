...
func (client *Client) handleRequest(req *proto.Request) bool {
	...
	case "send":
		...
		if req.Data == nil {
			...
			var frame proto.DataStruct
			if err := json.Unmarshal(*req.Data, &frame); err != nil {
				errorMsg = "malformed data field"
			} else {
				var crc64Table = crc64.MakeTable(crc64.ECMA)
				var hash = crc64.Checksum([]byte(frame.Str), crc64Table);
				
				client.respond("result", &proto.DataStruct{
